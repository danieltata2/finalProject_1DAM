...
<head>
    ...
    <title>Listado de Veterinarios - Veterinaria</title>
                ...
                <tbody>
                    <c:forEach var="veterinario" items="${lista}">
                        <tr>
                            ...
                            <td>
                                <div class="actions">
                                    <a href="VeterinarioControlador?opcion=editar&idVeterinario=${veterinario.idVeterinario}" class="btn btn-edit">
                                        <i class="fas fa-edit"></i> Editar
                                    </a>
                                    <a href="VeterinarioControlador?opcion=eliminar&idVeterinario=${veterinario.idVeterinario}" class="btn btn-delete">
