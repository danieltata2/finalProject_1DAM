...
<title>Registrar Animal - Clínica Veterinaria</title>
...
<body>
    <div class="container">
        <h1><i class="fas fa-paw"></i> Registrar Animal</h1>
        
        <form action="AnimalControlador" method="post">
            <input type="hidden" name="opcion" value="insertar">
            
            <div class="form-group">
                <label for="nombre">Nombre del Animal:</label>
                <input type="text" id="nombre" name="nombre" required placeholder="Ej: Max">
            </div>
            
            <div class="form-group">
                <label for="especie">Especie:</label>
                <input type="text" id="especie" name="especie" required placeholder="Ej: Canino, Felino, etc.">
            </div>
            
            <div class="form-group">
                <label for="genero">Género:</label>
                <input type="text" id="genero" name="genero" required placeholder="Ej: Macho, Hembra">
            </div>
