...
<head>
    ...
    <title>Listado de Clientes - Veterinaria</title>
                ...
                <tbody>
                    <c:forEach var="cliente" items="${lista}">
                        <tr>
                            ...
                            <td>
                                <div class="actions">
                                    <a href="ClienteControlador?opcion=editar&idCliente=${cliente.idCliente}" class="btn btn-edit">
                                        <i class="fas fa-edit"></i> Editar
                                    </a>
                                    <a href="ClienteControlador?opcion=eliminar&idCliente=${cliente.idCliente}" class="btn btn-delete">
